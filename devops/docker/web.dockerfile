...
# clean up old assets
RUN ./node_modules/.bin/ts-node -P ./packages/scripts/tsconfig.json --esm ./packages/scripts/index.ts azure/clean-blob-storage ${AZURE_STORAGE_ACCOUNT} ${AZURE_STORAGE_ACCOUNT_KEY} next
# upload new assets
RUN ./node_modules/.bin/ts-node -P ./packages/scripts/tsconfig.json --esm ./packages/scripts/index.ts azure/upload-to-blob-storage ${AZURE_STORAGE_ACCOUNT} ${AZURE_STORAGE_ACCOUNT_KEY} next apps/web/.next/static _next/static
