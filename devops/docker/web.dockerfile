...
RUN ENV=DOCKER yarn generate:ci
RUN ENV=DOCKER \
...
# clean up old assets
RUN AZURE_STORAGE_ACCOUNT=${AZURE_STORAGE_ACCOUNT} AZURE_STORAGE_ACCOUNT_KEY=${AZURE_STORAGE_ACCOUNT_KEY} yarn cdn:clean
# upload new assets
RUN AZURE_STORAGE_ACCOUNT=${AZURE_STORAGE_ACCOUNT} AZURE_STORAGE_ACCOUNT_KEY=${AZURE_STORAGE_ACCOUNT_KEY} yarn cdn:upload
