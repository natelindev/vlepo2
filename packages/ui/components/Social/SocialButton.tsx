...
import { useColor, useColorMode } from '@xstyled/styled-components';
...
const TelegramSocialButton = ({ color }: { color: string }) => {
  return (
    <g fill="none" fillRule="evenodd">
      <SocialGroupOutline color={color} strokeWidth="3" cx="50" cy="50" r="43.75" />
      <SocialGroupInnerCircle color={color} cx="50" cy="50" r="42" />
      <SocialGroupIcon
...
const GithubSocialButton = ({ color }: { color: string }): React.ReactElement => {
  ...
  return (
    <g fill="none" fillRule="evenodd">
      <SocialGroupOutline color={color} strokeWidth="20" cx="300" cy="300" r="262.5" />
      <SocialGroupInnerCircle color={color} cx="300" cy="300" r="252.5" />
      <SocialGroupIcon
        color={bgColor}
